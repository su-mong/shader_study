...
class Playlist extends _$Playlist {
  ...
  List<PlaylistSongModel> build() {
    return const [
      PlaylistSongModel(
        '0', artistImage: 'kanade.jpg', artistName: 'Otonose Kanade', songImageUrl: 's_cheerful_vibes_echo.jpg',
        title: 'Cheerful Vibes Echo', albumName: 'Cheerful Vibes Echo (Otonose Kanade SOLO)', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '1', artistImage: 'raden.jpg', artistName: 'Juufuutei Raden', songImageUrl: 's_otoshi_banashi.jpg',
        title: 'Otoshi Banashi', albumName: 'Otoshi Banashi (Juufuutei Raden SOLO)', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '2', artistImage: 'ririka.jpg', artistName: 'Ichijou Ririka', songImageUrl: 's_happiness_phenomenon.jpg',
        title: 'Happiness phenomenon', albumName: 'Happiness phenomenon (Ichijou Ririka SOLO)', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '3', artistImage: 'hajime.jpg', artistName: 'Todoroki Hajime', songImageUrl: 's_countach.jpg',
        title: 'Countach', albumName: 'Countach', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '4', artistImage: 'miko.jpg', artistName: 'Sakura Miko', songImageUrl: 's_flower_rhapsody.jpg',
        title: 'flower rhapsody', albumName: 'flower rhapsody', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '5', artistImage: 'okayu.jpg', artistName: 'Nekomata Okayu', songImageUrl: 's_poisonya_syndrome.jpg',
        title: 'KAMISAMA・NEKOSAMA', albumName: 'POISONYA SYNDROME', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '6', artistImage: 'iroha.jpg', artistName: 'Kazama Iroha', songImageUrl: 's_kazewo_aogishi_reiyona.jpg',
        title: 'Kazewo Aogishi Reiyona', albumName: 'Kazewo Aogishi Reiyona', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '7', artistImage: 'fubuki.jpg', artistName: 'Shirakami Fubuki', songImageUrl: 's_fbkingdom_blessing.jpg',
        title: 'SUPERNOVA', albumName: 'FBKINGDOM “Blessing”', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '8', artistImage: 'suisei.jpg', artistName: 'Hoshimachi Suisei', songImageUrl: 's_shinsei_mokuroku.jpg',
        title: 'BIBBIDIBA', albumName: 'SHINSEI MOKUROKU', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '9', artistImage: 'nene.jpg', artistName: 'Momosuzu Nene', songImageUrl: 's_nenechis_giragira_fan_meeting.jpg',
        title: 'Nenechi\'s Giragira Fan Meeting', albumName: 'Nenechi\'s Giragira Fan Meeting', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '10', artistImage: 'subaru.jpg', artistName: 'Oozora Subaru', songImageUrl: 's_starlight.jpg',
        title: 'starlight', albumName: 'starlight', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '11', artistImage: 'lui.jpg', artistName: 'Takane Lui', songImageUrl: 's_holohawk.jpg',
        title: 'HoloHawk', albumName: 'HoloHawk', totalSeconds: 230,
      ...
      PlaylistSongModel(
        '12', artistImage: 'marine.jpg', artistName: 'Houshou Marine', songImageUrl: 's_ahoy_youre_all_pirates.jpg',
        title: 'A Horny Money World 〜legendary night〜', albumName: 'Ahoy!! You\'re All Pirates♡', totalSeconds: 230,
